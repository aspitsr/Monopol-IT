...
public class Gui {
	...
	public void draw(Graphics g) {
		...
		g.drawString(Game.players.get(0).name + ": " + Game.players.get(0).money, 768+20, 420);
		g.drawString(Game.players.get(1).name + ": " + Game.players.get(1).money, 768+20, 440);	
		g.drawString(Game.players.get(2).name + ": " + Game.players.get(2).money, 768+20, 460);	
		g.drawString(Game.players.get(3).name + ": " + Game.players.get(3).money, 768+20, 480);	
